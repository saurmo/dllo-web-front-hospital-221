<template>
  <b-container>
    ...
    <b-form @submit="createRegistry" @reset="resetForm">
      ...
      <b-col offset="1">
        <b-form-group v-if="!searching">
          <b-button type="submit" variant="primary" v-if="!editing" class="myPrimary"
            >Save Registry</b-button
          >
          <b-button variant="success" @click="updateRegistry" v-else class="mySuccess"
            >Modify Registry</b-button
          >
          <b-button type="reset" variant="danger">Clear Form</b-button>

          <b-button variant="success" @click="searchPatient" v-if="!editing" class="mySuccess"
            >Filter Patient</b-button
          >
        </b-form-group>

        <b-form-group v-else>
          <b-button variant="success" @click="searchRegistriesPatient" class="mySuccess"
            >Search</b-button
          >
          <b-button variant="danger" @click="showAll">Cancel</b-button>
        </b-form-group>

        <b-button variant="success" @click="showAll" v-if="onePatient"
          >showAll</b-button
        >
      </b-col>
    </b-form>
    <br />
    <div class="table">
      <b-table sticky-header striped hover fixed bordered :items="registries" :fields="headers" head-variant="dark">
        <template #cell(options)="row">
          <b-button size="sm" @click="loadRegistry(row)" class="mr-2 myPrimary" variant="primary">
            Modify
          </b-button>

          <b-button size="sm" @click="deleteRegistry(row)" class="mr-2" variant="danger">
            Delete
          </b-button>
        </template>
      </b-table>
