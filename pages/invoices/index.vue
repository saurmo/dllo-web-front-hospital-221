<template>
  <b-container>
    ...
    <b-form @submit="createMedicalInstruments" @reset="resetForm">
      ...
      <b-form-group id="input-group-4" label="Medicamentos:" label-for="input-4">
        <b-form-select
          id="input-4"
          v-model="medicalInstrument.medicamentos"
...
export default {
  ...
  methods: {
    ...
    async loadMedicalInstruments() {
      ...
      let instrumentosMedicos = data;
      console.log(data);
      if (data.ok === true) {
        this.medicalInstruments = data.info;
        return instrumentosMedicos;
      } else {
